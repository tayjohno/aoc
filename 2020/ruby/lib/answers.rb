...
puts "\nday04"
I4.split("\n\n").map{_1.split.sort.join}.tap{|x|[/(([eib]yr|hgt|[he]cl|pid).+){7}/,/byr:(19[2-9]\d|200[0-2]).*ecl:(amb|blu|brn|gry|grn|hzl|oth)eyr:20(2\d|30)hcl:\#[\da-f]{6}hgt:((59|6\d|7[0-6])in|(1[5-8]\d|19[0-3])cm)iyr:20(1\d|20)pid:\d{9}\Z/].map{|e|p x.count{_1=~e}}}

puts "\nday05"
p I5.split.map{_1.tr("FLBR","001").to_i(2)}.sort.then{|l|((0..p(l[-1])).to_a-l)[-1]}
